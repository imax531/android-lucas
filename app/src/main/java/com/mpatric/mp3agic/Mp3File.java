...
public class Mp3File extends FileWrapper {
	...
	public void save(String newFilePath) throws IOException, NotSupportedException {
		if (file.compareTo(new File(newFilePath)) == 0) {
            throw new IllegalArgumentException("Save filename same as source filename");
        }
		RandomAccessFile saveFile = new RandomAccessFile(newFilePath, "rw");
		try {
			if (hasId3v2Tag()) {
